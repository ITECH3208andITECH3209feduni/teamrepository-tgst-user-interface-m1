...
try{
    ...
    $handle = $link->prepare('select i_value,rate from sales'); 
    $handle->execute(); 
    $result = $handle->fetchAll(\PDO::FETCH_OBJ);
		
    foreach($result as $row){
        array_push($dataPoints, array("y"=> $row->i_value, "label"=> $row->rate));
    }
	$link = null;
}
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title:{
		text: "Revenue Chart of TGST Corporation "
	},
	axisY: {
		title: "Revenue (in Rupee)",
		includeZero: true,
		prefix: "Rs",
		suffix:  ""
	},
