...
<div class="dropdown">
 ...
 <!-- Content Wrapper. Contains page content -->
  ...
  <?php 
    ...
    $sqlSelect = "SELECT * FROM purchase1";
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Purchase Data of the Company</h3>
				
              </div>
		
              <button class="btn-danger btn"> 
         <a href="delete.php" class="text-white"> Delete All Records</a>  </button>
			           <!-- /.card-header -->
              <div class="card-body">
         ...
         <a href="sdelete.php?p_id=<?php echo $row['p_id']; ?>" class="text-white"> Delete </a>  </button></td>
